...
class ValidationFeedback
{
    public function __construct(
        ...
        /** @var string[] */
        #[SchemaProperty(
            description: 'SOLO sezioni/informazioni presenti nel contesto di riferimento (slide + esempio reale) ma DEL TUTTO ASSENTI dal documento dello studente — non compaiono nemmeno in forma abbozzata, e per questo NON possono comparire in presentElements. Se il documento dello studente è molto più corto o semplice dell\'esempio di riferimento, questo elenco tipicamente NON è vuoto. Ma se il documento è già completo e copre tutto ciò che il contesto di riferimento richiede, questo elenco DEVE restare vuoto — non inventare un\'assenza pur di scrivere qualcosa: un elenco vuoto è una risposta corretta e accettabile quando non manca nulla. REGOLA ASSOLUTA: non scrivere MAI una frase che nega e poi ammette la stessa cosa nella stessa frase (es. "non è specificato X, anche se è indicato che X" oppure "non è specificato X, sebbene sia indicato Y") — se qualcosa è indicato/specificato da qualche parte nel documento, per definizione NON è un elemento mancante, e va omesso da questo elenco, non descritto con una frase contraddittoria. NON includere qui nulla che compaia già in presentElements: se un\'informazione è presente anche solo in parte, è un problema di QUALITÀ (va in structuralErrors), non di assenza. NON ripetere qui la stessa frase o lo stesso concetto già scritto in structuralErrors.',
            required: true,
        )]
